...
public class URLConnectionUtil {
	...
	public static String doPost(String urlStr, Map<String, Object> paramMap) throws Exception {
		...
		BufferedReader br = new BufferedReader(new InputStreamReader(conn.getInputStream(), "utf-8"));// 设置编码,否则中文乱码
		String line;
	...
	public static void doPut(String urlStr, Map<String, Object> paramMap) throws Exception {
		 ...
		 * InputStreamReader(conn.getInputStream(),"utf-8"));//设置编码,否则中文乱码 String line;
		 * String result = ""; while ((line = br.readLine()) != null) { result += "/n" +
		 * line; } System.out.println(result); br.close();
		 */
