...
public class MongoDB {
	...
	public Document getCurrentData(String document, String timeComlum, Map<String, Object> queryMap) {
		MongoDatabase db = mongodbFactory.getDb();
		// 获取所有查询记录
		FindIterable<Document> retDocument = db.getCollection(document).find(new Document(queryMap))
				.sort(new BasicDBObject(timeComlum, -1));
	...
	public boolean isDataExistBetween(String document, Map<String, String> queryMap) {
		...
		if (!queryMap.containsKey("deviceColumn") || !queryMap.containsKey("fromTime")
				|| !queryMap.containsKey("toTime") || !queryMap.containsKey("deviceId")
	 ...
	 */
	public boolean insertListDocuments(String document, List<Document> documentList) {
		try {
			MongoDatabase db = mongodbFactory.getDb();
	 ...
	 * @return
	 */
	public boolean updateDataByMutilCondition(String document, Map<String, Object> condition,
	 ...
	 * @return
	 */
	public String getOneColumn(String document, String columnname, String columnValue, final String targetColumn) {
		// 使用读源
		MongoDatabase db = mongodbFactory.getDb();
	 ...
	 * @return
	 */
	public List<Document> getInfoByTime(String collection, String timeColum, Map<String, String> paramMap,
	 ...
	 * @return
	 */
	public List<Document> listDocumentByTime(String document, String columnName, String columnValue, String timeName,
			String startTime, String endTime) {
